...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public RestAuthenticationEntryPoint restServicesEntryPoint() { // Class để custom giá trị trả về
        return new RestAuthenticationEntryPoint();
    }

    @Bean
    public CustomAccessDeniedHandler customAccessDeniedHandler() { // Class để custom giá trị trả về
